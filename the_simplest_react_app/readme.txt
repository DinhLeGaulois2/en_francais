...
1 - building the app with "create-react-app":
        npx create-react-app the_simplest_react_app
...
The direction of the circulating informations:
...
Explanations: 
    ...
    * "DumbComponent": display the values (and other information) from the variables (states)
=============================================================================================
